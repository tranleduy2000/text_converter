...
public class DigestUtils {
    ...
    public static String md2Hex(final byte[] data) {
        return FHex.encodeHexString(md2(data));
    }
    ...
    public static String md5Hex(final byte[] data) {
        return FHex.encodeHexString(md5(data));
    }
    ...
    public static String sha1Hex(final byte[] data) {
        return FHex.encodeHexString(sha1(data));
    }
    ...
    public static String sha256Hex(final byte[] data) {
        return FHex.encodeHexString(sha256(data));
    }
    ...
    public static String sha384Hex(final byte[] data) {
        return FHex.encodeHexString(sha384(data));
    }
    ...
    public static String sha512Hex(final byte[] data) {
        return FHex.encodeHexString(sha512(data));
    }
   ...
   @Deprecated
    ...
    public String digestAsHex(final byte[] data) {
        return FHex.encodeHexString(digest(data));
    }
