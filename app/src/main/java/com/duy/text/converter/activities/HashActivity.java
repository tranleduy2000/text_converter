...
import com.duy.text.converter.fragments.HashFragment;
...
public class HashActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (hashFragment == null) {
            hashFragment = HashFragment.newInstance();
        }
        FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
        fragmentTransaction.replace(R.id.content, hashFragment, HashFragment.class.getName());
