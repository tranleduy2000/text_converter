 ...
 */
public class BinaryToolTest extends TestCase {
    public void testEncode() throws Exception {
        String encode = new BinaryTool().encode("\u6c49\u8bed/\u6f22\u8a9e; H\u00e0ny\u01d4 or \u4e2d\u6587; Zh\u014dngw\u00e9n");
    ...
    public void testDecode() throws Exception {
        String decode = new BinaryTool().decode(
                new BinaryTool().encode("\u6c49\u8bed/\u6f22\u8a9e; H\u00e0ny\u01d4 or \u4e2d\u6587; Zh\u014dngw\u00e9n"));
