...
public class MainActivityPro extends MainActivity {
    ...
    private PagerSectionAdapterPro mAdapter;
    ...
    private void bindView() {
        ...
        mAdapter = new PagerSectionAdapterPro(this, getSupportFragmentManager(), text);
    ...
    private class KeyBoardEventListener implements ViewTreeObserver.OnGlobalLayoutListener {
        MainActivityPro activity;

        KeyBoardEventListener(MainActivityPro activityIde) {
